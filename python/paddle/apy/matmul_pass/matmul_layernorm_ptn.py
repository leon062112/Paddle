...
class MatmulLayernormFusion(abstract_drr.DrrPass):
    ...
    def source_pattern(self, o, t):
        # matmul: input0 @ input1 -> mm_out
        o.matmul_op = o.ap_native_op("pd_op.matmul")
        o.matmul([t.input0, t.input1], [t.mm_out])

        # layer_norm: mm_out + ln_scale + ln_bias -> ln_out (ignore mean/var)
        o.ln = o.ap_native_op("pd_op.layer_norm")
        # layer_norm 有 5 attrs: epsilon, begin_norm_axis, etc., but we ignore in pattern
        o.ln([t.mm_out, t.ln_scale, t.ln_bias], [t.ln_out, t.mean, t.var])  # 可选输出
